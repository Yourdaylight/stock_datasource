...
class StrategyGeneratorAgent(ArenaAgentBase):
    ...
    def get_system_prompt(self) -> str:
        ...
        personality_desc = (
            f"Your investment style is {self.personality}." if self.personality else ""
        )
        focus_desc = (
            f"You focus on: {', '.join(self.focus_areas)}." if self.focus_areas else ""
        )
...
"""
        ...
        refined.discussion_rounds = (
            strategy.discussion_rounds + [round_id]
            if round_id
