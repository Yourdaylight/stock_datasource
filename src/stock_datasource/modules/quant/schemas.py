...
class DataRequirementStatus(BaseModel):
    ...
    existing_date_range: list[str] | None = None
    missing_dates: list[str] = Field(default_factory=list)
    record_count: int = 0
...
class DataReadinessResult(BaseModel):
    ...
    missing_summary: MissingDataSummary | None = None
...
class ScreeningResultItem(BaseModel):
    ...
    cashflow_sync_ratio: float | None = None
...
class DeepAnalysisResult(BaseModel):
    ...
    stock_name: str = ""
    analysis_date: str = ""
    tech_snapshot: TechSnapshot | None = None
    ai_analysis: AiAnalysisCard | None = None
    tech_score: float = 0
...
class SignalResult(BaseModel):
    ...
    market_risk: MarketRiskStatus | None = None
    data_readiness: DataReadinessResult | None = None
    execution_time_ms: int = 0
...
class QuantConfig(BaseModel):
    ...
    config_name: str = ""
    config_type: str = (
        ""  # screening_rules / factor_weights / signal_params / risk_params
    )
