...
class NewsSentiment(BaseModel):
    ...
    score: float = Field(
        default=0.0, ge=-1.0, le=1.0, description="情绪分数，-1.0到1.0"
    )
...
class NewsItem(BaseModel):
    ...
    news_src: str | None = Field(
        default=None, description="新闻源标识（如sina/cls/新华社）"
    )
    ...
    sentiment: NewsSentiment | None = Field(default=None, description="情绪分析结果")
    sentiment_score: float | None = Field(
        default=None, ge=-1.0, le=1.0, description="情绪分数，-1.0到1.0"
    )
    sentiment_reasoning: str | None = Field(default=None, description="情绪分析理由")
    impact_level: ImpactLevel | None = Field(default=None, description="影响程度")
        ...
        if has_flat:
            data["sentiment"] = {
                ...
                "impact_level": getattr(
                    data.get("impact_level"), "value", data.get("impact_level") or "low"
                ),
            }
...
class ResearchReport(BaseModel):
    ...
    abstract: str | None = Field(default=None, description="研报摘要")
    author: str | None = Field(default=None, description="作者")
    ts_code: str | None = Field(default=None, description="股票代码")
    inst_csname: str | None = Field(default=None, description="券商名称")
    ind_name: str | None = Field(default=None, description="行业名称")
...
class PolicyItem(BaseModel):
    ...
    pubtime: datetime | None = Field(default=None, description="发布时间")
    title: str = Field(..., description="标题")
    content_html: str | None = Field(default=None, description="正文HTML")
    pcode: str | None = Field(default=None, description="发文字号")
    puborg: str | None = Field(default=None, description="发文机关")
    ptype: str | None = Field(default=None, description="主题分类")
    url: str | None = Field(default=None, description="原文链接")
...
class AnalyzeSentimentRequest(BaseModel):
    ...
    stock_code: str | None = Field(
        default=None, description="关联股票代码（用于上下文）"
    )
