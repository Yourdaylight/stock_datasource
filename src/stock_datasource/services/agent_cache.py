...
class AgentSharedCache:
    ...
    def set_session_data(
        self, session_id: str, key: str, value: Any, ttl: int = None
    ) -> bool:
        ...
        return self._cache.set(
            self._session_key(session_id, key), value, ttl or self.TTL_SESSION_DATA
        )
    ...
    def cache_stock_info(self, ts_code: str, info: dict[str, Any]) -> bool:
        ...
        """
        return self._cache.set(
            self._stock_key(ts_code, "info"), info, self.TTL_STOCK_INFO
        )
    ...
    def cache_stock_daily(
        self, ts_code: str, start_date: str, end_date: str, data: list[dict]
    ) -> bool:
        ...
        return self._cache.set(
            self._stock_key(ts_code, key), data, self.TTL_STOCK_DAILY
        )
    ...
    def cache_stock_realtime(self, ts_code: str, data: dict[str, Any]) -> bool:
        ...
        """
        return self._cache.set(
            self._stock_key(ts_code, "realtime"), data, self.TTL_STOCK_REALTIME
        )

    def get_stock_realtime(self, ts_code: str) -> dict[str, Any] | None:
    ...
    def cache_stock_financial(
        self, ts_code: str, period: str, data: dict[str, Any]
    ) -> bool:
    ...
    def get_stock_financial(self, ts_code: str, period: str) -> dict[str, Any] | None:
    ...
    def cache_analysis_result(
        self, agent_name: str, query_hash: str, result: Any, ttl: int = None
    ) -> bool:
        ...
        return self._cache.set(
            self._shared_key(key), result, ttl or self.TTL_ANALYSIS_RESULT
        )

    def get_analysis_result(self, agent_name: str, query_hash: str) -> Any | None:
    ...
    def cache_stock_batch(
        self, stocks: list[dict[str, Any]], data_type: str = "info"
    ) -> int:
    ...
    def get_stock_batch(
        self, ts_codes: list[str], data_type: str = "info"
    ) -> dict[str, Any]:
    ...
    def cache_index_data(self, index_code: str, data: dict[str, Any]) -> bool:
        ...
        """
        return self._cache.set(
            self._shared_key(f"index:{index_code}"), data, self.TTL_STOCK_REALTIME * 5
        )

    def get_index_data(self, index_code: str) -> dict[str, Any] | None:
...
# Singleton instance
_agent_cache: AgentSharedCache | None = None
