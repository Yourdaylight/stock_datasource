...
- 风险提示""",
    ...
    def get_workflow(self, workflow_id: str) -> AIWorkflow | None:
        """获取工作流。"""
        # 先检查模板
    ...
    def clone_from_template(self, template_id: str, new_name: str) -> AIWorkflow | None:
        """从模板创建工作流副本。"""
    ...
    def _save_workflow(self, workflow: AIWorkflow):
        ...
        with open(path, "w", encoding="utf-8") as f:
            json.dump(
                workflow.model_dump(), f, ensure_ascii=False, indent=2, default=str
            )
