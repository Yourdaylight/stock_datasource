"""TuShare cash flow statement data extractor."""
...
class CashflowExtractor:
    """Extractor for TuShare cash flow statement data."""
    ...
    def _call_api(self, **kwargs) -> pd.DataFrame:
        """Call TuShare cashflow API with rate limiting and retry."""
        self._rate_limit()
        
        try:
            result = self.pro.cashflow(**kwargs)
    ...
    def extract(self, ts_code: str, start_date: Optional[str] = None,
