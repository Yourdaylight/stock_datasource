...
class TuShareBalancesheetVipService(BaseService):
    ...
    def get_balancesheet_by_period(
    ...
    def get_balancesheet_summary(self, period: str) -> dict[str, Any]:
        ...
        return {
            ...
            "avg_total_assets": float(row["avg_total_assets"])
            if row["avg_total_assets"]
            else None,
            "avg_total_liab": float(row["avg_total_liab"])
            if row["avg_total_liab"]
            else None,
