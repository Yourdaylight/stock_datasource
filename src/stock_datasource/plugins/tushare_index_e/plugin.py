"""TuShare index_e data plugin implementation."""
...
class TuShareIndexEPlugin(BasePlugin):
    """TuShare index_e data plugin (中证指数估值)."""
    
    @property
    def name(self) -> str:
        return "tushare_index_e"
    ...
    def description(self) -> str:
        return "TuShare CSI index valuation (中证指数估值数据)"
