"""TuShare ETF fund adjustment factor extractor."""
...
class ETFFundAdjExtractor:
    """Extractor for TuShare ETF fund adjustment factor data."""
    ...
    def extract(
        ...
        """Extract ETF fund adjustment factor data.
        ...
        Returns:
            DataFrame with ETF fund adjustment factor data
        """
        kwargs = {}
        ...
        return self._call_api(self.pro.fund_adj, **kwargs)


# Global extractor instance
extractor = ETFFundAdjExtractor()
