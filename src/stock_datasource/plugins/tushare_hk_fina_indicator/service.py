...
class TuShareHKFinaIndicatorService(BaseService):
    ...
    @query_method(
        ...
        params=[
            ...
            QueryParam(
                name="report_type",
                type="str",
                description="Report type: Q1/Q2/Q3/Q4",
                required=False,
            ),
        ],
    )
    def get_financial_indicators(
        self, code: str, periods: int | None = 8, report_type: str | None = None
    ) -> list[dict[str, Any]]:
    ...
    @query_method(
        ...
        params=[
            QueryParam(
                name="code", type="str", description="HK stock code", required=True
            ),
            QueryParam(
                name="periods",
                type="int",
