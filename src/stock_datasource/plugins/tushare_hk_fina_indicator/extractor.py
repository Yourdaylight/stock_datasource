"""TuShare HK financial indicators data extractor."""
...
class HKFinaIndicatorExtractor:
    """Extractor for TuShare HK financial indicators data."""
    ...
    def _call_api(self, **kwargs) -> pd.DataFrame:
        """Call TuShare HK fina indicator API with rate limiting and retry."""
        self._rate_limit()
        
        try:
            result = self.pro.hk_fina_indicator(**kwargs)
    ...
    def extract(self, ts_code: str, period: Optional[str] = None,
        ...
        """Extract HK financial indicators data.
        ...
        Returns:
            DataFrame with HK financial indicators data
        """
...
extractor = HKFinaIndicatorExtractor()
