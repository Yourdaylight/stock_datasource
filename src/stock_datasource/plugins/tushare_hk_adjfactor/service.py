...
class TuShareHKAdjFactorService(BaseService):
    ...
    def get_latest(self, ts_code: str) -> dict[str, Any] | None:
    ...
    def calculate_adjusted_price(
        self, ts_code: str, trade_date: str, price: float
    ) -> float | None:
        ...
        """
        df = self.db.execute_query(
            sql, {"ts_code": ts_code, "trade_date": formatted_date}
        )
    ...
    def get_statistics(self, trade_date: str | None = None) -> dict[str, Any]:
