"""TuShare sw_daily data extractor."""
...
class SwDailyExtractor:
    """Extractor for TuShare sw_daily data (申万行业指数日线)."""
    ...
    def _call_api(self, **kwargs) -> pd.DataFrame:
        ...
        try:
            with proxy_context():
                result = self.pro.sw_daily(**kwargs)
