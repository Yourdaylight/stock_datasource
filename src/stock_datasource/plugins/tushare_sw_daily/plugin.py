"""TuShare sw_daily data plugin implementation."""
...
class TuShareSwDailyPlugin(BasePlugin):
    """TuShare sw_daily data plugin (申万行业指数日线)."""
    
    @property
    def name(self) -> str:
        return "tushare_sw_daily"
    ...
    def description(self) -> str:
        return "TuShare SW industry index daily data (申万行业指数日线行情)"
