"""TuShare index dailybasic data extractor."""
...
class IndexDailybasicExtractor:
    """Extractor for TuShare index dailybasic data."""
    ...
    def _call_api(self, **kwargs) -> pd.DataFrame:
        ...
        try:
            with proxy_context():
                result = self.pro.index_dailybasic(**kwargs)
...
extractor = IndexDailybasicExtractor()
