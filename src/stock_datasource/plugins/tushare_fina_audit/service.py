...
class TuShareFinaAuditService(BaseService):
    ...
    def get_audit_opinion(
        self, code: str, periods: int | None = 5
    ) -> list[dict[str, Any]]:
    ...
    def get_non_standard_opinions(
        self, start_date: str, end_date: str, limit: int | None = 100
    ) -> list[dict[str, Any]]:
    ...
    @query_method(
        ...
        params=[
            QueryParam(
                name="agency",
                type="str",
                description="Accounting firm name (partial match)",
                required=True,
            ),
            QueryParam(
                name="year",
    ...
    def get_audit_by_agency(
        self, agency: str, year: str | None = None, limit: int | None = 100
    ) -> list[dict[str, Any]]:
    ...
    @query_method(
        ...
        params=[
            QueryParam(
                name="year", type="str", description="Year (YYYY format)", required=True
            )
        ],
    )
