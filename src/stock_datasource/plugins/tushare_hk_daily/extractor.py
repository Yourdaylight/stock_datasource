"""TuShare Hong Kong Stock Daily data extractor."""
...
class HKDailyExtractor:
    """Extractor for TuShare Hong Kong Stock daily price data."""
    ...
    def extract(
        ...
        return self._call_api(self.pro.hk_daily, **kwargs)
