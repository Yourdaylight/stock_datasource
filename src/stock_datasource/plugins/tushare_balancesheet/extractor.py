"""TuShare balance sheet data extractor."""
...
class BalancesheetExtractor:
    """Extractor for TuShare balance sheet data."""
    ...
    def _call_api(self, **kwargs) -> pd.DataFrame:
        """Call TuShare balancesheet API with rate limiting and retry."""
        self._rate_limit()
        
        try:
            result = self.pro.balancesheet(**kwargs)
