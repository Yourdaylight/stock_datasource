"""TuShare top institutional seats data extractor."""
...
class TopInstExtractor:
    """Independent extractor for TuShare top institutional seats data."""
    ...
    def extract(self, trade_date: str, ts_code: Optional[str] = None) -> pd.DataFrame:
        """Extract top institutional seats data for a specific trade date.
