...
class TuShareCashflowVipService(BaseService):
    ...
    def get_cashflow_by_period(self, period: str, report_type: Optional[str] = "1",
    ...
    def get_cashflow_summary(self, period: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_operating_cf": float(row['avg_operating_cf']) if row['avg_operating_cf'] else None,
            "avg_investing_cf": float(row['avg_investing_cf']) if row['avg_investing_cf'] else None,
            "avg_financing_cf": float(row['avg_financing_cf']) if row['avg_financing_cf'] else None
        }
