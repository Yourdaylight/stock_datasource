...
class DataLoader:
    ...
    def load_daily_data(
        self, data: pd.DataFrame, table_name: str = "ods_daily"
    ) -> dict[str, Any]:
    ...
    def load_adj_factor_data(
        self, data: pd.DataFrame, table_name: str = "ods_adj_factor"
    ) -> dict[str, Any]:
    ...
    def load_daily_basic_data(
        self, data: pd.DataFrame, table_name: str = "ods_daily_basic"
    ) -> dict[str, Any]:
