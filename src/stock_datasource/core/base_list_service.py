...
class FilterConfig:
    ...
    options_query: str | None = None  # SQL to get options
    options: list[dict[str, Any]] | None = None  # Static options
...
class BaseListService(ABC):
    ...
    def _build_where_clause(
        ...
        if keyword:
            ...
            if search_fields:
                ...
                search_conditions = [
                    f"{field} ILIKE '%{keyword_escaped}%'" for field in search_fields
                ]
    ...
    def get_list(self, params: ListQueryParams) -> ListResponse:
        ...
        return ListResponse(
            total=total, page=params.page, page_size=params.page_size, data=data
        )
    ...
    def get_detail(self, id_field: str, id_value: str) -> dict[str, Any] | None:
