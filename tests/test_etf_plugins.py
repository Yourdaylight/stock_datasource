...
class TestETFFundDailyPlugin:
    ...
    def test_plugin_creation(self):
        """Test plugin can be created."""
        from stock_datasource.plugins.tushare_etf_fund_daily import (
            TuShareETFFundDailyPlugin,
        )
    ...
    def test_extract_data(self):
        ...
        try:
            ...
            data = plugin.extract_data(
                ts_code="510330.SH", start_date="20260101", end_date="20260110"
            )
            print(f"\n[extract_data] Result: {len(data)} records")
...
class TestETFFundAdjPlugin:
    ...
    def test_plugin_creation(self):
        """Test plugin can be created."""
        from stock_datasource.plugins.tushare_etf_fund_adj import (
            TuShareETFFundAdjPlugin,
        )
...
class TestETFStkMinsPlugin:
    ...
    def test_plugin_creation(self):
        """Test plugin can be created."""
        from stock_datasource.plugins.tushare_etf_stk_mins import (
            TuShareETFStkMinsPlugin,
        )
