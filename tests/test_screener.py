...
class TestScreenerSchemas:
    ...
    def test_screener_condition_schema(self):
        ...
        condition = ScreenerCondition(field="pe_ttm", operator="<", value=30)
    ...
    def test_screener_request_schema(self):
        ...
        from stock_datasource.modules.screener.schemas import (
            ScreenerCondition,
            ScreenerRequest,
        )
    ...
    def test_stock_profile_schema(self):
        ...
        profile = StockProfile(
            ...
            dimensions=[
                ProfileDimension(
                    name="估值", score=70.0, level="B", weight=0.2, indicators={}
                )
            ],
            recommendation="建议持有",
        )
...
class TestScreenerService:
    ...
    def test_filter_by_conditions(self):
        ...
        conditions = [ScreenerCondition(field="pe_ttm", operator="<", value=40)]
...
class TestScreenerAPI:
    ...
    def test_filter_endpoint(self, client):
        ...
        response = client.post(
            "/api/screener/filter",
            json={
                "conditions": [{"field": "pe_ttm", "operator": "<", "value": 30}],
                "limit": 10,
            },
        )
    ...
    def test_nl_screener_endpoint(self, client):
        ...
        response = client.post(
            "/api/screener/nl", json={"query": "找出PE小于20的白酒股票"}
        )
...
class TestConditionValidation:
    ...
    def test_condition_field_types(self):
        ...
        # List condition
        list_cond = ScreenerCondition(
            field="industry", operator="in", value=["白酒", "电子"]
        )
