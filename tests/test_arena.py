...
class TestArenaConfig:
    ...
    def test_default_config_values(self):
        ...
        config = ArenaConfig(name="Test Arena", description="Test description")
...
class TestComprehensiveScorer:
    ...
    def test_score_calculation_range(self):
        ...
        score.stability_score = DimensionScore(
            dimension="stability", score=70.0, weight=0.2
        )
        score.adaptability_score = DimensionScore(
            dimension="adaptability", score=65.0, weight=0.2
        )
...
class TestThinkingMessage:
    ...
    def test_thinking_message_creation(self):
        ...
        from stock_datasource.arena import MessageType, ThinkingMessage
...
class TestDiscussionRound:
    ...
    def test_discussion_round_creation(self):
        ...
        from stock_datasource.arena import DiscussionMode, DiscussionRound
...
class TestArena:
    ...
    def test_arena_active_strategy_count(self):
        ...
        from stock_datasource.arena import Arena, ArenaConfig, ArenaStrategy
