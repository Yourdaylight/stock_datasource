...
class TestTaskNameConsistency:
    ...
    def test_with_group_name_returns_group_name(self):
        ...
        row = {"group_name": "ETF完整数据", "trigger_type": "group", "total_plugins": 3}
    ...
    def test_group_type_multiple_plugins_without_group_name(self):
        ...
        row = {"group_name": None, "trigger_type": "group", "total_plugins": 3}
    ...
    def test_empty_group_name_uses_fallback(self):
        ...
        row = {"group_name": "", "trigger_type": "group", "total_plugins": 3}
...
class TestListAndDetailConsistency:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"group_name": None, "trigger_type": "group", "total_plugins": 3},
                "组合同步 (3个)",
            ),
            # Case 3: Single manual plugin
            (
                {
                    "group_name": "tushare_daily_basic",
                    "trigger_type": "manual",
                    "total_plugins": 1,
                },
                "tushare_daily_basic",
            ...
            # Case 4: Batch manual
            (
                {"group_name": None, "trigger_type": "manual", "total_plugins": 5},
                "手动同步 (5个)",
            ),
            # Case 5: Scheduled
            (
                {"group_name": None, "trigger_type": "scheduled", "total_plugins": 20},
                "定时同步 (20个)",
            ),
        ],
    )
